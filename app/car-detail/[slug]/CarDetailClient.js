      ...
      <div className="mx-auto mt-16 max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 xl:grid-cols-12">
          <div className="space-y-8 xl:col-span-8">
            ...
            <div className="rounded-xl border border-purple-200 bg-white p-4 shadow-md dark:border-gray-700 dark:bg-gray-800">
              <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex-1">
                  ...
                  <h2 className="mb-2 text-lg font-semibold text-gray-900 dark:text-white sm:text-xl">
                    {loading ? (
                      <Skeleton width={200} />
                    ) : (
                      `${car?.make} ${car?.model}`
                  ...
                  <div className="text-lg font-semibold text-purple-600 dark:text-white sm:text-xl">
                    {loading ? (
                      <Skeleton width={150} />
                    ) : (
              ...
              <div className="flex flex-col gap-2 sm:flex-row">
                <button
                  ...
                  className="flex flex-1 items-center justify-center rounded-lg border border-purple-600 bg-purple-600 px-4 py-2 text-sm font-medium text-white shadow transition-all duration-200 hover:border-purple-700 hover:bg-purple-700"
                >
                ...
                <button
                  ...
                  className="flex flex-1 items-center justify-center rounded-lg border border-purple-600 bg-transparent px-4 py-2 text-sm font-medium text-purple-600 shadow transition-all duration-200 hover:bg-purple-600 hover:text-white"
                >
